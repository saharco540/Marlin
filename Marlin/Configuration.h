...
#define CUSTOM_MACHINE_NAME "CTC A10S"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 187.10
  #define DEFAULT_bedKi 20.52
  #define DEFAULT_bedKd 137.6
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.40, 80.12, 396.05, 140 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -50.16, -27.3, 0 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INCLUDE_CENTE              // Move to the center after the last corner
...
//#define TOUCH_SCREEN
  ...
  //#define TOUCH_OFFSET_X        45.15
  //#define TOUCH_OFFSET_Y        8.28
  //#define TOUCH_ORIENTATION TOUCH_LANDSCAPE TEST
