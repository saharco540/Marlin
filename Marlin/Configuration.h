...
#ifndef MOTHERBOARD
  // The only differance between V3 & V4 is the displayed version number in marlin.
...
#define CUSTOM_MACHINE_NAME "Hizba A10M"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, 0, -0.6}
