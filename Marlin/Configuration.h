...
// Choose the name from boards.h that matches your setup
  ...
  #define MOTHERBOARD BOARD_GT2560_V4_A20
#endif
...
#define MIXING_EXTRUDER
  ...
  #define MIXING_PRESETS         // Give 8 default vtool presets for 2 or 3 MIXING_STEPPERS
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A20M [@thinkyhead]
    ...
    // FIND YOUR OWN: "M303 E1 C20 S250" to run autotune.
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKd 674.78  
  // FIND YOUR OWN: "M303 E-1 C20 S70" to run autotune.
#endif // PIDTEMPBED
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_Z_RAISE_WHEN_OFF_MESH 5 // When the nozzle is off the mesh, this value is used as the Z-Height correction value.
